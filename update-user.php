      ...
      <div class="col-md-6 offset-md-3">
        <form id="registrationForm" method="post" class="form-horizontal" style="border:1px solid #ececec;margin-top:50px;padding:15px;">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="birthday" placeholder="YYYY/MM/DD" value="<?php echo $yyyy_mm_dd; ?>" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="landmark" value="<?php echo $landmark; ?>" />
            </div>
          </div>
  ...
  $(document).ready(function(){
    ...
    .on('success.form.bv', function(e) {
      ...
      $.ajax({
        ...
        url       : 'ajaxupdate.php', // the url where we want to POST
